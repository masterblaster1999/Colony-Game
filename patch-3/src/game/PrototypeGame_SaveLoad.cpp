...
struct AsyncSaveManager {
    ...
    struct Snapshot {
        ...
        // v13+ sleep/rest tuning
        double restPerColonistPerSecond = 0.01;
        double colonistMaxPersonalRest = 10.0;
        double colonistSleepThresholdRestDay = 2.0;
        double colonistSleepThresholdRestNight = 5.0;
        double colonistSleepRestorePerSecond = 1.0;
        double colonistSleepRestorePerSecondNoBed = 0.5;

        // v13+ day/night tuning
        double dayLengthSeconds = 300.0;
        double nightStart01 = 0.75;
        double nightEnd01 = 0.25;
...
private:
    ...
    static Snapshot MakeSnapshot(const proto::World& world, double playtimeSeconds)
    {
        ...
        // v13+ world clock
        s.timeSeconds = world.timeSeconds();
    ...
    s.farmHarvestDurationSeconds = world.farmHarvestDurationSeconds;
        ...
        // v13+ sleep/rest tuning
        s.restPerColonistPerSecond = world.restPerColonistPerSecond;
        s.colonistMaxPersonalRest = world.colonistMaxPersonalRest;
        s.colonistSleepThresholdRestDay = world.colonistSleepThresholdRestDay;
        s.colonistSleepThresholdRestNight = world.colonistSleepThresholdRestNight;
        s.colonistSleepRestorePerSecond = world.colonistSleepRestorePerSecond;
        s.colonistSleepRestorePerSecondNoBed = world.colonistSleepRestorePerSecondNoBed;

        // v13+ day/night tuning
        s.dayLengthSeconds = world.dayLengthSeconds;
        s.nightStart01 = world.nightStart01;
        s.nightEnd01 = world.nightEnd01;
        ...
        s.builtBeds       = world.builtCount(proto::TileType::Bed);
        ...
        for (const auto& c : cols)
        {
            ...
            out.personalRest = c.personalRest;
    ...
    static bool WriteSnapshotJson(const Snapshot& s, Kind kind, const fs::path& path, bool pretty, std::string& outErr)
    {
        try
        {
            ...
            j["tuning"] = {
                ...
                {"restPerColonistPerSecond", s.restPerColonistPerSecond},
                {"colonistMaxPersonalRest", s.colonistMaxPersonalRest},
                {"colonistSleepThresholdRestDay", s.colonistSleepThresholdRestDay},
                {"colonistSleepThresholdRestNight", s.colonistSleepThresholdRestNight},
                {"colonistSleepRestorePerSecond", s.colonistSleepRestorePerSecond},
                {"colonistSleepRestorePerSecondNoBed", s.colonistSleepRestorePerSecondNoBed},
                {"dayLengthSeconds", s.dayLengthSeconds},
                {"nightStart01", s.nightStart01},
                {"nightEnd01", s.nightEnd01},
            };
