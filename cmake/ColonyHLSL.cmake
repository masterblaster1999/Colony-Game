...
function(colony_add_hlsl target)
  ...
  function(_colony_guess_stage in out_var)
    set(stage "Pixel")
    if ("${in}" MATCHES "_VS\\.hlsl$")
      set(stage "Vertex")
    elseif("${in}" MATCHES "_PS\\.hlsl$")
      set(stage "Pixel")
    elseif("${in}" MATCHES "_GS\\.hlsl$")
      set(stage "Geometry")
    elseif("${in}" MATCHES "_HS\\.hlsl$")
      set(stage "Hull")
    elseif("${in}" MATCHES "_DS\\.hlsl$")
      set(stage "Domain")
    elseif("${in}" MATCHES "_CS\\.hlsl$")
      set(stage "Compute")
    endif()
